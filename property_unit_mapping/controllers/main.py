    ...
    def unit_map_data(self, project_id, exclude_draft=False, **kw):
        ...
        return {
            ...
            'units': [{
                ...
                'sale_lease': line.property_id.sale_lease or '',
                'is_rental': line.property_id.sale_lease == 'for_tenancy',
    ...
    def subproject_unit_map_data(self, subproject_id, exclude_draft=False, **kw):
        ...
        return {
            'project': {
                ...
                'is_land': self._is_land(subproject),
