...
# Part of TechKhedut. See LICENSE file for full copyright and licensing details.
{
    ...
    'data': [
        ...
        'views/rental_dashboard_view.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'rental_management/static/src/css/lib/leaflet.css',
            ...
            'rental_management/static/src/js/lib/jquery.dataTables.min.js',
            'rental_management/static/src/js/lib/dataTables.bootstrap5.min.js',
            'rental_management/static/src/js/lib/echarts.min.js',
            'rental_management/static/src/js/lib/chart.umd.min.js',
            'rental_management/static/src/js/lib/leaflet.js',
