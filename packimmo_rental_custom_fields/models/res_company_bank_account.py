...
class ResCompanyBankAccount(models.Model):
    _name = "res.company.bank.account"
    _description = "Comptes bancaires société"
    ...
    account_name = fields.Char(
        ...
        required=True,
        help="Ex : Compte courant principal, Compte salaires, Compte EUR",
    )
